...
def _draw_residence_pdf_content(p, width, height):
    ...
    _draw_field(p, 4.5 * cm, y_body, 10 * cm, "Unité 15", "NOM DU QUARTIER")
    p.setFont("Helvetica", 13)
    p.setFillColor(NOIR)
    ...
    p.drawCentredString(6*cm, box_y + 3.4*cm, "PARCELLES ASSAINIES")
    p.setFont("Helvetica-Bold", 14)
...
pix.save('C:/Users/senep/.gemini/antigravity-ide/brain/69704cf6-39b3-48ed-8c23-d8a83e781d23/certificat_residence_fictif_paysage.png')
