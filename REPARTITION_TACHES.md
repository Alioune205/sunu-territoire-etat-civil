...
> [!IMPORTANT]
> **Priorité maximale** — DEV 1A débloque DEV 3, DEV 2B et DEV 4 sur le flux OTP.
...
> [!CAUTION]
> **Livraison critique pour le jury** — tout le monde attend le PDF généré.
...
> [!NOTE]
> Tout est débloqué immédiatement. Impact principal sur DEV 2A (dashboard admin).
...
> [!NOTE]
> OCR est entièrement indépendant. Ndiogoye se développe **en binôme avec DEV 1A**.
...
## 💻 DEV 2A — Dashboard Admin React

> [!TIP]
> **~70% du travail est débloqué maintenant.** Démarrer sans attendre.
...
## 🌐 DEV 2B — Frontend React Citoyen

> [!TIP]
> Construire les **UI mockées en avance** (OTP, Ndiogoye, PDF). Les brancher dès que l'API arrive.
...
> [!TIP]
> Tout est débloqué sauf l'écran OTP (attend DEV 1A). Démarrer par onboarding + login.
...
> [!TIP]
> Construire toute l'UI avec des **données mockées** sans attendre DEV 3. Brancher l'auth après.
